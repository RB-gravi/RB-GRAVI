...
import { ArrowRight, CheckCircle2, Clock3, ShieldCheck, Sparkles, Target, Zap } from "lucide-react"
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-16 pt-8 sm:px-6 lg:gap-24 lg:px-8 lg:pt-12">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg border bg-background p-3">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Clear launch narratives across teams.</p>
                </div>
                <div className="rounded-lg border bg-background p-3">
                  <div className="flex items-center gap-2 text-sm font-medium">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Pre-release checks reduce messaging gaps.</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="space-y-6" aria-labelledby="value-proposition-heading">
          <div className="space-y-2">
            ...
            <h2 id="value-proposition-heading" className="text-3xl font-semibold tracking-tight">
              One cohesive workflow from engineering updates to customer-facing outcomes.
            </h2>
          </div>
        ...
        <section id="how-it-works" className="space-y-6" aria-labelledby="flow-heading">
          <div className="space-y-2">
            ...
            <h2 id="flow-heading" className="text-3xl font-semibold tracking-tight">
              A simple release narrative flow that keeps teams moving.
            </h2>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="max-w-xl space-y-2">
              ...
              <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">
                Bring product, marketing, and release teams into one confident go-to-market rhythm.
              </h2>
              <p className="text-sm text-muted-foreground sm:text-base">
                Start with a live walkthrough to see how GravityLink turns every release into a clear customer outcome.
              </p>
            </div>
            <Button size="lg" asChild>
              <Link href="mailto:sales@gravitylink.com">
                Talk to sales
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
